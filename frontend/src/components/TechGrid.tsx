      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-5 md:gap-6">
          {techItems.map((tech, index) => (
            <div 
              key={index}
              className="group relative p-5 md:p-6 rounded-3xl paper-card hover:paper-well transition-all duration-300 flex flex-col items-center text-center cursor-default select-none"
            >
